...
<em>trainingsmartedit/web/features/trainingsmarteditContainer/trainingsmarteditcontainermodule.ts</em>
```ts
...
SmartEdit uses Webpack, a module bundler, to bundle the application. The TypeScript source code is transpiled into JavaScript and the existing JavaScript code (ES5) is bundled as is. The following files are the Webpack configuration for the trainingsmartedit:
- <em>trainingsmartedit/smartedit-custom-build/generated/webpack.[dev/prod/karma].smartedit.config.js</em>
- <em>trainingsmartedit/smartedit-custom-build/generated/webpack.[dev/prod/karma].smarteditContainer.config</em>

The 'trainingsmartedit' layer of trainingsmartedit is a bundle of trainingsmartedit and trainingsmarteditcommons.
The 'trainingsmarteditContainer' layer of trainingsmartedit is a bundle of trainingsmarteditContainer and trainingsmarteditcommons.
