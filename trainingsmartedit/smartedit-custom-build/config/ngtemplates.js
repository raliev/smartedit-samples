...
module.exports = function() {
    ...
    return {
        ...
        config: function(data, conf) {
            ...
            conf.trainingsmartedit = generateConfigForFolder('trainingsmartedit');
            conf.trainingsmarteditcommons = generateConfigForFolder('trainingsmarteditcommons');
            conf.trainingsmarteditContainer = generateConfigForFolder('trainingsmarteditContainer');
